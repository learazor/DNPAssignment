...
public class ListPostView
{
    ...
    public ListPostView(IPostRepository postRepository, ICommentRepository commentRepository,
    ...
    private async Task ViewPostsAsync()
    {
        ...
        while (true)
        {
            ...
            if (int.TryParse(input, out postId))
            {
                ...
                SinglePostView singlePostView = new SinglePostView(postRepository, commentRepository, userRepository, postId);
